...
contract Reclaim is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function fetchWitnessesForClaim(
        ...
        for (
            ...
            witnessesLeftList[witnessIndex] = witnessesLeftList[
                witnessesLeft - 1
            ];
    ...
    function merkelizeUser(
        ...
        uint256 groupId = calculateGroupIdFromProvider(
        ...
        SemaphoreInterface(semaphoreAddress).addMember(
            groupId,
            _identityCommitment
        );
    ...
    function calculateGroupIdFromProvider(
        ...
        bytes memory hashedProvider = abi.encodePacked(
            keccak256(providerBytes)
        );
    ...
    function calculateUserParamsHash(
        ...
        bytes32 userParamsHash = keccak256(
            abi.encodePacked(provider, delimiter, params)
        );
